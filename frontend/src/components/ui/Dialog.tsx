...
/** Crear el componente de Dialogo */
...
/** Definir el contenido del Dialogo */
...
/** Definir el encabezado del Dialogo  */
...
const DialogDescription = forwardRef<ComponentRef<typeof DialogPrimitive.Description>, ComponentPropsWithoutRef<typeof DialogPrimitive.Description>>(
  ({ className, ...props }, ref) => (
